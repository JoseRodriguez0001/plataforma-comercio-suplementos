          ...
          <div>
            ...
            <p>
              {product.length && product.width && product.height
                ? `${product.length}L x ${product.width}An x ${product.height}Al`
                : "-"}
            </p>
          </div>
        </div>
      ...
      <div className="grid grid-cols-1 gap-y-8">
        <div className="flex items-start gap-x-2">
          ...
          <div>
            ...
            <p className="max-w-sm">
              Tu paquete llegará en 3 a 5 días hábiles a tu punto de recogida o
        ...
        <div className="flex items-start gap-x-2">
          ...
          <div>
            ...
            <p className="max-w-sm">
              ¿El producto no era lo que esperabas? Sin problema, lo cambiamos
              por uno nuevo.
            </p>
          </div>
        </div>
        <div className="flex items-start gap-x-2">
          ...
          <div>
            ...
            <p className="max-w-sm">
              ...
              complicaciones: haremos lo posible para que tu devolución sea
              sencilla.
            </p>
          </div>
        </div>
